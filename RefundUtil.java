...
public class RefundUtil {
	 ...
	 * @return
	 */
	public static String wechatRefund1(App app,String out_trade_no,String total_fee1,String refund_fee1){
		...
		try {
			...
			if(result.equals("SUCCESS")){
				...
				return (String) resultMap.get("err_code_des");
			}
		} catch (Exception e) {
